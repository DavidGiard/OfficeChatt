...
namespace XamarinConnect
{
    public partial class MainPage : ContentPage
    {
        ...
        public static async Task<IUserDirectReportsCollectionWithReferencesPage> GetDirectReports()
        {
            IUserDirectReportsCollectionWithReferencesPage users = null;

            try
            {
                var graphClient = AuthenticationHelper.GetAuthenticatedClient();
                users = await graphClient.Me.DirectReports.Request().GetAsync();
